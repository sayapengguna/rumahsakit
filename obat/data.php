        ...
        <div style="margin-bottom: 20px; ">
            <form action="" class="form-inline" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" name="pencarian" placehodel="pencarian ">
                </div>
                <div class="form-group">
                            ...
                            while($data = mysqli_fetch_array($sql_obat)) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="del.php?id=<?=$data['id_obat']?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
